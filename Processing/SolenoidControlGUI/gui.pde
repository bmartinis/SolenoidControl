...
public void createGUI(){
	...
	label2 = new GLabel(this, 5, 5, 210, 20);
	label2.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
	label2.setText("Merge");
	label2.setTextBold();
	label2.setOpaque(false);

	label3 = new GLabel(this, 220, 5, 210, 20);
	label3.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
	label3.setText("Waste");
	label3.setTextBold();
	label3.setOpaque(false);

	label4 = new GLabel(this, 435, 5, 210, 20);
	label4.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
	label4.setText("Droplet Generator");
	label4.setTextBold();
	...
	option66.setOpaque(false);
	option66.addEventHandler(this, "option66_clicked1");
	option67 = new GOption(this, 5, 50, 120, 20);
	option67.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
	option67.setText("Merge Off");
	...
	option68.setOpaque(false);
	option68.addEventHandler(this, "option68_clicked1");
	option69 = new GOption(this, 220, 50, 120, 20);
	option69.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
	option69.setText("Waste Off");
	...
	option70.setOpaque(false);
	option70.addEventHandler(this, "option70_clicked1");
	option71 = new GOption(this, 435, 50, 60, 20);
	option71.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
	...
	option72.setOpaque(false);
	option72.addEventHandler(this, "option72_clicked1");
	option73 = new GOption(this, 580, 50, 60, 20);
	option73.setIconAlign(GAlign.LEFT, GAlign.MIDDLE);
	option73.setText("Case D");
	option73.setOpaque(false);
